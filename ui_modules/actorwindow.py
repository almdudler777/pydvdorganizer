...
class Ui_actorWindow(object):
    def setupUi(self, actorWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ui\\res/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.movieAdd.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("ui\\res/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.movieRemove.setIcon(icon1)
